-- Intermediate business-effective item history built from transactional business dates.
-- This model owns version construction; analyst-facing business labels belong in the mart.
