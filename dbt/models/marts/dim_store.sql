-- dim_store is currently modeled as a Type 1 dimension:
-- keep the latest known record per store_number for current-state analysis.
-- Future enhancement: upgrade to SCD Type 2 to preserve historical changes
-- such as store relocations, renames, or address updates.
